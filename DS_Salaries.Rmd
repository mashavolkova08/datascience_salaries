...
In this case we have factors `work_year`, `experience_level`, `employment_type`, `job_title`, `employee_residence`, `remote_ratio`, `company_location`, and `company_size`.
...
## Linear Regression
```{r}
lm.salaries = lm(salary_in_usd~ work_year + experience_level + employment_type + job_title + employee_residence + remote_ratio + company_location + company_size, data = ds.salaries)
